...
import profile1 from "../../assets/img/portfolio/portfolio-1.jpg";
import profile2 from "../../assets/img/portfolio/portfolio-2.jpg";
import profile3 from "../../assets/img/portfolio/portfolio-3.jpg";
import profile4 from "../../assets/img/portfolio/portfolio-4.jpg";
import profile5 from "../../assets/img/portfolio/portfolio-5.jpg";
import profile6 from "../../assets/img/portfolio/portfolio-6.jpg";
import profile7 from "../../assets/img/portfolio/portfolio-7.jpg";
import profile8 from "../../assets/img/portfolio/portfolio-8.jpg";
import profile9 from "../../assets/img/portfolio/portfolio-9.jpg";
...
import { USER_ID, USER_INFO } from "../../utils";
...
const Home = () => {
  ...
  useEffect(() => {
    getData(`skills`).then((res) => {
      let data = res.data.data.filter((skill) => skill.user === USER_ID);
      setSkills(data);
    });
  }, [USER_ID]);
      ...
      <main id="main">
        ...
        >
          <div className="hero-container" data-aos="fade-in">
            <h1>
              {USER_INFO?.lastName} <br /> {USER_INFO?.firstName}
            </h1>
            <p>
              I'm{" "}
                  ...
                  <div className="col-lg-6">
                    <ul>
                      <li>
                        ...
                        <span>{USER_INFO?.birthday.split("T")[0]}</span>
                      </li>
                      <li>
                        <i className="bi bi-chevron-right"></i>{" "}
                      ...
                      <li>
                        <i className="bi bi-chevron-right"></i>{" "}
                        <strong>City:</strong> <span>{USER_INFO?.address}</span>
                      </li>
                    </ul>
                  </div>
                  <div className="col-lg-6">
          ...
          <div className="container">
            ...
            <div className="row skills-content">
              <div className="col-lg-6 aos-init aos-animate" data-aos="fade-up">
                {skills
                  ?.slice(0, skills.length / 2 + (skills.length % 2))
                  .map((skill, i) => (
                    <ProgressBar
                      key={i}
                      skill={skill.name}
              ...
              >
                {skills
                  ?.slice(skills.length / 2 + (skills.length % 2))
                  .map((skill, i) =>
                    skill.user === USER_ID ? (
                      <ProgressBar
                        key={i}
